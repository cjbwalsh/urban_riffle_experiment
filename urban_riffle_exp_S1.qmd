...
survey_data <- data.frame(readxl::read_excel("/mnt/uomShare/wergStaff/ChrisW/git-data/urban_riffle_experiment/data_sources/urban_riffle_exp_survey_data_combined.xlsx"), stringsAsFactors = FALSE)
survey_dates <-  data.frame(readxl::read_excel("/mnt/uomShare/wergStaff/ChrisW/git-data/urban_riffle_experiment/data_sources/urban_riffle_exp_survey_data_combined.xlsx", sheet = 2), stringsAsFactors = FALSE)
...
Riffles after construction in 5 of the experimental sites.
:::
