...
#Note ht, widths and incip_diam incomplete at time of entry. Still need to find old records.
...
# organic matter only collected in trips 1-4
samples[samples$date > as.Date("1997-06-30"),om_types$field] <- NA
```
...
# missing
# unique(substr(samples$old_samplecode,1,nchar(samples$old_samplecode)-2)[is.na(samples$med_phi)])
# "1E"  "1F"  "1M"  "2F"  "2M"  "3Bl" "3Br" "3D"  "3E"  "3F"  "3H"  "3M"  "3S"  "4Bl" "4Br" "4D"  "4F"  "4H"  "4M"  "4S"  "5Bl" "5Br"...need to find field sheets.
# "5D"  "5E"  "5F"  "5H"  "5M"  "5O"  "5S"  "6Bl" "6Br" "6D"  "6E"  "6F"  "6H"  "6M"  "6O"  "6S" 
