---
title: "Appendix S2: Notes on data preparation"
format: docx
editor: visual
bibliography: references.bib
---

This document provides further detail on the assembly of environmental and biological data used in the study. It also includes explanatory notes for non-standard taxonomic names used.
...
Microturbellaria CRC sp. 1, 2, and 3. (**Need to find correspondence on this**).
...
<!--# Perhaps I should include a statement about exclusion of taxa: e.g. A. small (i.e. likely to pass through a 250 um mesh), likely plankton species such as Copepods, except for Cyclopoids of which large specimens were found abundanantly; B. not-truly aquatic species. e.g. Collembola (and some oher taxa I will need to check).  I have, however, included megadrile oligochaetes: "These supposedly terrestrial species have been collected in freshwater often enough to suggest that they might be genuine aquatic or semi-aquatic species rather than incidentals" [@martin2008].-->
