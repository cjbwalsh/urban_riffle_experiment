---
title: "Appendix S2: Notes on biological data preparation"
format: docx
editor: visual
...
<!--# Perhaps I should include a statement about exclusion of taxa: e.g. A. small (i.e. likely to pass through a 250 um mesh), likely plankton species such as Copepods, except for Cyclopoids of which large specimens were found abundantly; B. not-truly aquatic species. e.g. Collembola (and some oher taxa I will need to check).  I have, however, included megadrile oligochaetes: "These supposedly terrestrial species have been collected in freshwater often enough to suggest that they might be genuine aquatic or semi-aquatic species rather than incidentals" [@martin2008].-->
