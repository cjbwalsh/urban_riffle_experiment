...
Six of the sites were randomly chosen for local-scale habitat remediation works, with the other three remaining as controls (Fig. 1). 

Artificial riffles were installed at these sites in May 1996. These consisted from 15-40 cm diameter rocks, specifically designed to provide an increase in both habitat heterogeneity and stability, and to mimic the typical practice used for stabilizing stream beds in Melbourne.
