...
After each sample unit was collected, the sampler was removed and water depth and velocity at the bed surface were measured at the four corners of the sampled area and the centre point. We measured velocity with a CMC 20 current meter counter, fitted with a 1-94.22 propeller, for 10 s at each point, 4 cm above the bottom (the lowest possible setting). From these five measurements, we calculated the mean and variance of velocity for each sample unit.
