...
stanfit_i$save_output_files(
  ...
  basename = "fit_nbinom_b1234a_cii_2000iter_ll", timestamp = FALSE, random = FALSE)
stanfit_i$sampler_diagnostics()
saveRDS(stanfit_i, file = "~/uomShare/wergStaff/ChrisW/git-data/urban_riffle_experiment/model_fits/fit_nbinom_b1234a_cii_2000iter_ll.rds")
