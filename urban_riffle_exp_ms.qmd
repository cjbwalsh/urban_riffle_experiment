...
Re-introduction of riffle-pool sequences is a common element of channel engineering projects [@miller_etal_2010; @palmer_etal_2010]. Rock riffles in particular, by providing shallower, faster and more variable flow conditions than a channelized runs, add heterogeneity to simplified channels at the reach scale. Within riffles, more variable flow, depth and substrate can provide habitat variability for stream invertebrates [e.g. @statzner_etal_1988] and fish [e.g. @kessler_thorp_1993]. Emergent rocks, which are common features of riffles, can be important sites for oviposition of many insect species with stream-dependent larvae [@lancaster_etal_2010].

However, reviews of the small proportion of river restoration projects that included assessment of ecological response have broadly concluded that recovery of biological assemblages is rare [@palmer_etal_2010; @palmer_etal_2014a; @miller_etal_2010], with @miller_etal_2010 concluding that the strength and consistency of response was affected by catchment-scale condition. Further studies [e.g. @violin_etal_2011; @sudduth2011] pointed to the overriding influence of catchment-scale impacts, particularly in urban catchments that are likely to limit the effects of small-scale morphological change [@bernhardt_palmer_2011]. Despite these conclusions a decade ago, channel engineering and 'daylighting' of buried streams in urban catchments with an objective of providing habitat for stream biota remain popular endeavours [@scoggins_etal_2022; @melbournewater_2019; @delibas_tezer_2017].

@rubin_etal_2017 critiqued the reviews of @palmer_etal_2010 and @miller_etal_2010, noting that only a minority of the studies considered were robustly designed with before-after monitoring (and very few with \>1 y after monitoring), or with comparisons between restored and control or reference sites, or with assessment of the degree of change in heterogeneity. They also pointed to the limitations to understanding afforded by the use of simple metrics of richness and diversity as criteria for restoration success.

We aim to address such limitations by providing robust evidence that instream biotic assemblages that are limited by catchment-scale urban impacts are little affected by increased in-stream habitat heterogeneity. We report on a replicated before-after-control-impact experiment of the effects of constructed riffles in simplified streams of urban catchments spanning a range of low to moderate urban density. We compare 6 experimental reaches in which riffles were constructed with 3 control reaches without riffles, measuring densities of macroinvertebrate taxa twice before riffle construction, twice 1 year after, and twice 5-6 years after. We use a hierarchical multi-taxon model to assess changes in the abundance of taxa resulting from the riffles, thus providing a rich description of assemblage response accounting for taxon identity [@ovaskainen_etal_2017], while also reporting richness and biotic metrics more typically used to assess responses to channel change. The experimental addition of riffles to the simplified channels adds reach-scale heterogeneity to the channel by creating a new habitat type absent in the before state and in control sites: we assess the extent of the increased heterogeneity by measuring variation in depth, velocity and substrate at the scale at which invertebrates were sampled.
...
-   Total macroinvertebrate abundance, of EPT taxa (insect orders dominated by taxa sensitive to human disturbance, @resh_jackson_1993), and of Diptera and Oligochaeta (QDLO, groups dominated by taxa tolerant to human disturbance, @martin2008, @gooderham_tsyrlin_2002).
...
Need to address the question of whether the lack of change is a result of lack of colonizers [@sundermann et al_2011]or a lack of persistence. Perhaps the longer-term monitoring of (at least) Brushy could be used to inform this: infrequent repeated occurrences of sensitive taxa....
