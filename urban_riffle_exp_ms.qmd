...
[@ovaskainen_etal_2017]
Trends in subsample proportions over the 6 sampling periods differed among the study sites, potentially leading to differing biases in abundance estimates over time and among sites [@buonaccorsi_2010; @kery_schaub_2011]. We thus accounted for subsampling error in our statistical models (see below). 

We used a similar model structure to assess the effect of the riffles on environmental variables, and on the abundances of macroinvertebrate taxa collected in each sample unit. In all cases, the effects of primary interest were the interaction between the before-after effect (*BA*) and the control-impact effect (*CI*), which indicate an effect observed after riffle construction in impact sites that was not observed in control sites. We also assessed the three-way interaction between *BA*, *CI* and *I* (transformed and scaled EI), which indicates whether any effect of riffle construction is dependent upon the level of catchment urbanization.
