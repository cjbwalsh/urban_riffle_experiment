...
"Urban streams...are increasingly recognized as ecological and social amenities worthy of restoration and public investment (Palmer et al 2014; Hong and Chang 2020).

Multiple objectives: "regulatory compliance (!?), flood relief, aesthetic improvments and recreation"...(none of these meet the definition of ecologically successful restoration...but they cite Doyle and Shields 2012, Naiman 2013, Baker et al 2014, and Hawley 2022 in support of this statement).

later: "goals can span improving flood management, ecological habitat (!), aesthetics, recreation, community building, etc, (Smith et al 2014, Moran et al 2019)"

Scoggins et al don't really define what they mean by successful and sustainable urban stream restoration (end of intro)

By their own admission, there was a lack of 'obvious stormwater management solutions' in any of their case studies...making them complex and challenging problems...(Or more realistically, impossible cases for *stream* restoration)...they talk of eco-sociological tradeoffs in urban stream management, but I think they need to separate the primary ecological limitation: if they can't do anything about stormwater management, then instream restoration has to be off the table, and it becomes about improving the stream floodplain as parkland...no?

"Explicitly incorporating social dimensions into restoration is essential for adequately defining and achieving the goals..of the restoration itself [@smith2016]."

More restoration in well-off areas [@stanford2018].

One statement stuck in my craw particularly: "...ecologists suggested diversity of aquatic macroinvertebrates as a benchmark for successful restoration, but this was a relatively low priority for non-ecologists"....Expand on this in SUSE keynote if not here.

'Success in urban stream restoration is subjective and multidimensional' [@yocom2014]. In fact, @yocom2014 doesn't say it's subjective. He correctly notes potential benefits (successes) that might be achieved even without ecological success. (Stakeholder success, e.g. improved aesthetics, economic benefits, infrastructure protection or recreation; and Learning success, e.g. citizen eduction, scientific contribution, management experience, improved method).

"restoration focused purely on social goals may be driven by community decision makers and my be largely independent of stream conditions [@dacruzesousa2017]". They compared two restoration projects in Quito and found that the collaborative project, designed and executed by the community was more successful than the project led by the government. Neither project explicitly considered the stream ecosystem!

Their Fig 3C is the LSC model. A particularly silly one!

Their description of the most direct root (Transdisciplinary, community powered-stream restoration) seems sensible (and very similar to the path taken by the MW HWS), but this really needs a consideration of scale.
...
Scoggins et al (2022) noted this paper (about community involvement in a proposed daylighting project in Manchester) described a 'tremendous' range of visions brought by community members: not one mentioned the stream! "waterway restoration has tended to privilege ecological over social objectives, while public engagement in project conceptualization has been limited, conducted 'downstream' subsequent to planning and design stages. Restoration schemes have therefore tended to reflect the concerns of professionals rather than communities, overlooking their potential for social renewal and change."

"...daylighting involves the exposing of an entirely concealed ecosystem amenity [@baker_etal_2014]"

#### [@wild2011]

"Culverts can have several effects on local river and wetland habitat by modifying substrate, altering flow, reducing algal and plant growth and dissociating the stream from the surrounding terrestrial environment (Macdonald & Davies 2007). Removing culverts therefore has a high potential to improve aquatic and marginal habitats."

Major environmental focus is on fish passage, but... "Some projects reported that deculverted stretches were increasingly colonised by wildlife such as amphibians, birds and invertebrates (e.g. nos 6, 7, 15, 20 and 33). However, the sources of colonisation of these organisms must be present at the catchment scale to achieve such ecological benefits of deculverting (Palmeretal.1997;Ja ̈hnigetal.2009)." (Most references associated with these numbers will be difficult to track down).
...
"Most oligochaetes are benthic deposit feeders and burrow in the sediment, ingesting large amounts of particles. A distinctive group of the family Tubificidae, the subfamily Naidinae, is adapted to live on the sediment surface or to swim among the macrovegetation where they feed on algae. Only a few freshwater oligochaetes (e.g., species of *Chaetogaster*) are predatory, but such a behaviour is rare throughout the group." [@martin2008].
...
Other taxa which increased in abundance following riffle construction in more urban streams that likely include filter-feeding species that could use the rock substrates were: Simuliidae,
...
Consider the question of lack of colonisers vs the ability of colonisers to persist in these streams. (Maybe cite @clinton2022 here.

### @palmer_etal_2014a

...the theoretical basis of restoration ecology is firmly rooted in classic ecology; restoration projects provide unique opportunities to test much of that theory. There is a strong emphasis on understanding what factors enhance restoration of biodiversity (Rodrigues et al. 2011), on the role of physical habitat heterogeneity in the rate and degree of recovery (Holl et al. 2013), and on the use of resilience theory---thresholds, state changes, and feedbacks (Suding et al. 2004)---in understanding the potential for an ecosystem to be restored. Spatial ecology also plays a prominent role in restoration research, particularly including a focus on dispersal dynamics, metapopulation theory, and the landscape context of restoration sites (Reynolds et al. 2013).

The emergence of restoration ecology as applied to rivers and streams is much more recent than that for terrestrial ecosystems, and its theoretical basis has been more grounded in the physical sciences, especially hydrology and geomorphology, than in the ecological sciences. Dominant perspectives on the science and practice of river restoration are driven by social dynamics both external to and internal to the community of scientists and restoration practitioners.

...reconfiguring the channel to accommodate degraded hydrogeomorphic regimes is more common than restoring the hydrologic and sediment regimes themselves. As a result, such projects become channel design activities and fail to address the issues necessary for true restoration, like water allocation or increasing infiltration capacity of watershed soils. Channel reconfiguration is especially common in urban and agricultural regions in which river channels may be reshaped and boulders, wood, and rock deflectors added to slow water flow. In addition, banks may be armored with material to minimize erosion from excessive runoff

NCD (Natural channel design, Rosgen, 1998, 2011) and other channel design approaches are the most common stream restoration approaches

Similarly, if the hydrologic regime is restored but there is no nearby source of invertebrate colonists, then the in-stream communities will remain unrestored [@sundermann_etal_2011]

Unfortunately, recovery of biodiversity was rare for the vast majority of stream restoration projects, and this appears to be closely related to the restoration method. For the most common type of projects---those implemented using channel or in-stream hydrogeomorphic adjustments only 16% showed any improvement in biodiversity (as a Shannon type index or an IBI),

They class IBI as a diversity index because "it provides more information about community composition than number of EPT or species richness and because it takes into account relative abundances of all species regardless of their level of tolerance to some stressor" (as opposed to EPT richness, or presumably SIGNAL...I'm not really sure I buy this distinction: surely the IBI score is weighted against some reference condition)

### @miller_etal_2010  

A stronger analysis than Palmer et al 2010, of pretty much the same set of studies.  They conducted a meta-analysis of d: the difference in density or richness between restored and unrestored reaches or between pre- and post-restoration conditions, scaled by the pooled standard deviation;  (density or richness?)

Study selection criteria included: 
"(4) macroinvertebrate responses quantified at the reach and not microhabitat-scale (macroinvertebrates sampled within individual microhabitats [e.g., edge, macrophyte, thalweg] were pooled for analysis when possible);" (Not really sure where that leaves our study!)
"and (5) study design included a before-after (BA), beforeafter-control-impact (BACI), or control-impact (CI) design." this seems counter to what rubin et al claimed!

"the small number of published studies precluded the use of channel reconfiguration studies."...that's ok - they just didn't include the reconfiguration studies that they did consider in the differing effects of restoration type.



### @hobbs_etal_2012

Escalating global change is resulting in widespread no-analogue environments and novel ecosystems that render traditional goals unachievable. (Need to present an argument that the degraded urban stream should not be considered a novel ecosystem).
